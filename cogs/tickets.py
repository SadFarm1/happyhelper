...
class Tickets(commands.Cog):
    ...
    async def on_guild_channel_create(self, channel):
        ...
        if True:
            #Welcome, Due to higher than normal inquires our response times are drastically delayed while we work through the tickets, thanks for your patience and understanding!
            embed = discord.Embed(
                    title = "Ticket Alert",
